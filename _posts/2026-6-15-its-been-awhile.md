...
We also remembering one resource saying there are two generations a year - that's kind of false? The entire lifespan is one year, considering their very length pupation\... We're not sure where that "two generations a year" metric came from. Maybe they mean in a different way than we are imagining.
